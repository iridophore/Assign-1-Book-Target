...
IL2CPP_EXTERN_C const RuntimeType* PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2_0_0_0_var;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayableDirector_SendOnPlayableDirectorPlay_m4E9920374473D4726C270EF6ECACA93303C7BA87 (PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2 * __this, const RuntimeMethod* method)
{
	...
	DECLARE_METHOD_EXEC_CTX(methodExecutionContext, PlayableDirector_SendOnPlayableDirectorPlay_m4E9920374473D4726C270EF6ECACA93303C7BA87_RuntimeMethod_var, methodExecutionContextThis, NULL, NULL);
	...
	}
	{
		...
		STORE_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 7));
		NullCheck(L_1, ((g_sequencePointsUnityEngine_DirectorModule + 5)));
		...
		CHECK_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 7));
	}

IL_0018:
	{
		CHECK_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 6));
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayableDirector_SendOnPlayableDirectorPause_m4E43A08D82CCE58DE75A1D9605A716BD85837F81 (PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2 * __this, const RuntimeMethod* method)
{
	...
	DECLARE_METHOD_THIS(methodExecutionContextThis, (&__this));
	DECLARE_METHOD_EXEC_CTX(methodExecutionContext, PlayableDirector_SendOnPlayableDirectorPause_m4E43A08D82CCE58DE75A1D9605A716BD85837F81_RuntimeMethod_var, methodExecutionContextThis, NULL, NULL);
	CHECK_METHOD_ENTRY_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 8));
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 9));
	{
	...
	{
		CHECK_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 12));
		Action_1_t25E50453F931760A3FC110C4EC79B73BBC203021 * L_1 = __this->get_paused_5();
		CHECK_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 13));
		STORE_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 15));
		NullCheck(L_1, ((g_sequencePointsUnityEngine_DirectorModule + 13)));
		Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537(L_1, __this, /*hidden argument*/Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537_RuntimeMethod_var);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayableDirector_SendOnPlayableDirectorStop_mB1699B938518B0D2CBB70B6A7678FBA8A83839A8 (PlayableDirector_tAE05A3F910B71FA6BC7EED28C26C35945308D2B2 * __this, const RuntimeMethod* method)
{
	...
	DECLARE_METHOD_THIS(methodExecutionContextThis, (&__this));
	DECLARE_METHOD_EXEC_CTX(methodExecutionContext, PlayableDirector_SendOnPlayableDirectorStop_mB1699B938518B0D2CBB70B6A7678FBA8A83839A8_RuntimeMethod_var, methodExecutionContextThis, NULL, NULL);
	CHECK_METHOD_ENTRY_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 16));
	CHECK_METHOD_EXIT_SEQ_POINT(methodExitChecker, methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 17));
	{
		CHECK_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 18));
		CHECK_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 19));
	...
	}
	{
		...
		STORE_SEQ_POINT(methodExecutionContext, (g_sequencePointsUnityEngine_DirectorModule + 23));
		NullCheck(L_1, ((g_sequencePointsUnityEngine_DirectorModule + 21)));
		Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537(L_1, __this, /*hidden argument*/Action_1_Invoke_mE8C21024872FD84A7DB7C11BE8A207AD3A97C537_RuntimeMethod_var);
